        ...
        <div className="w-full max-w-6xl mx-auto p-4 space-y-4">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                <div>
                    ...
                    <p className="text-sm text-base-content/70">Grouped by lender and chain, including long / short exposure and 24h change.</p>
                </div>
                    ...
                    <table className="table table-zebra table-sm w-full">
                        ...
                        <tbody>
                            {visibleLenders.map((lender) => {
                                const worstHealth =
                                    lender.healthFactors && lender.healthFactors.length ? Math.min(...lender.healthFactors) : undefined
                                const maxLev = lender.leverages && lender.leverages.length ? Math.max(...lender.leverages) : undefined
                                            ...
                                            {worstHealth != null ? (
                                                <span
                                                    className={`badge badge-sm ${
                                                        worstHealth < 1.1 ? "badge-error" : worstHealth < 1.3 ? "badge-warning" : "badge-success"
                                                    }`}
                                                    title={
