...
// Unified Earn ships enabled — set VITE_UNIFIED_EARN_ENABLED=false in .env to
// hide the tab again.
export const UNIFIED_EARN_ENABLED = import.meta.env.VITE_UNIFIED_EARN_ENABLED !== 'false'
