...
import { LendingPoolsTable } from './components/lending/Pools'
import { ThemeSwitcher } from './components/themeSwitcher'
import { WalletConnect } from './components/connect'

export default function App() {
  const { address, isConnected } = useAccount()
  const [activeTab, setActiveTab] = useState<'transactions' | 'lending'>(
    'lending'
  )
              ...
              <div className="join">
                <button
                  className={`btn btn-sm join-item ${
                    activeTab === 'lending' ? 'btn-primary' : 'btn-ghost'
                  }`}
            ...
            <div className="w-full min-w-[300px]">
              ...
              <div className="card bg-base-100 shadow-xl rounded-2xl">
                <div className="card-body p-4 sm:p-6">
                  {activeTab === 'lending' && <LendingPoolsTable />}
