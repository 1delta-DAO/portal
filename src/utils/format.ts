...
// Moved to the sdk (domain classification, not formatting); re-exported so the
// many existing `utils/format` imports keep working.
export { riskBand } from '../sdk/lending-helper/risk'
